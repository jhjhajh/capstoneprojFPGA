...
# 17 "./define.h"
 ...
 float weights_0[12][12] = {{1}};
 float weights_1[48][12] = {{1}};
 float weights_2[36][48] = {{1}};
 float weights_3[24][36] = {{1}};
 float weights_4[12][24] = {{1}};
 float weights_5[6][12] = {{1}};
 float bias_0[12] = {0};
 float bias_1[48] = {0};
 float bias_2[36] = {0};
 float bias_3[24] = {0};
...
# 26 "main.cpp"
 ...
 dot<float, 12, 0> dot_1;
 dot<float, 12, 0> dot_2;
 VITIS_LOOP_37_1: while (true) {
  AXIS_wLAST in, out;
  if (flag == 0) {
   S_AXIS >> in;
   if (in.data == 0) {
   ...
   retrieve_inputs:for (int i = 0; i < 12; i++) {
    S_AXIS >> in;
    input[i] = in.data;
   }
   flag = 2;
