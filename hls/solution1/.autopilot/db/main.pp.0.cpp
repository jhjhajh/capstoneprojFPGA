...
void mlp_nn(hls::stream<AXI_L>& S_AXIS, hls::stream<AXI_L>& M_AXIS) {
...
# 25 "main.cpp"
 ...
 dot<float, 562, 0> dot_1;
 dot<float, 562, 0> dot_2;
 VITIS_LOOP_38_1: while (true) {
  AXI_L in, out;
  if (flag == 0) {
   loadweights0:for (int i = 0; i < 562; i++) {
    VITIS_LOOP_42_2: for (int j = 0; j < 562; j++) {
     S_AXIS >> in;
     weights_0[i][j] = in.data;
    }
   }
   loadweights1:for (int i = 0; i < 128; i++) {
    VITIS_LOOP_48_3: for (int j = 0; j < 562; j++) {
     S_AXIS >> in;
     weights_1[i][j] = in.data;
    }
   }
   loadweights2:for (int i = 0; i < 96; i++) {
    VITIS_LOOP_54_4: for (int j = 0; j < 128; j++) {
     S_AXIS >> in;
     weights_2[i][j] = in.data;
    }
   }
   loadweights3:for (int i = 0; i < 48; i++) {
    VITIS_LOOP_60_5: for (int j = 0; j < 96; j++) {
     S_AXIS >> in;
     weights_3[i][j] = in.data; }
   }
   loadweights4:for (int i = 0; i < 12; i++) {
    VITIS_LOOP_65_6: for (int j = 0; j < 48; j++) {
     S_AXIS >> in;
     weights_4[i][j] = in.data; }}
   loadweights5:for (int i = 0; i < 6; i++) {
    VITIS_LOOP_69_7: for (int j = 0; j < 48; j++) {
     S_AXIS >> in;
     weights_4[i][j] = in.data; }
   }
   loadbias0:for (int i = 0; i < 562; i++) {
    S_AXIS >> in;
    bias_0[i] = in.data;
   }
   loadbias1:for (int i = 0; i < 128; i++) {
    S_AXIS >> in;
    bias_1[i] = in.data;
   }
   loadbias2:for (int i = 0; i < 96; i++) {
    S_AXIS >> in;
    bias_2[i] = in.data;
   }
   loadbias3:for (int i = 0; i < 48; i++) {
    S_AXIS >> in;
    bias_3[i] = in.data;
   }
   loadbias4:for (int i = 0; i < 12; i++) {
    S_AXIS >> in;
    bias_4[i] = in.data;
   }
   loadbias5:for (int i = 0; i < 12; i++) {
    S_AXIS >> in;
    bias_5[i] = in.data;
   }
   flag = 1;
   ...
   retrieve_inputs:for (int i = 0; i < 562; i++) {
    S_AXIS >> in;
    input[i] = in.data;
   }
   flag = 3;
